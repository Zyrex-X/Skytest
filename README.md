...
Title = "Lunar Hub",     
Text = "Wellcome to Luñār Hüb",
Icon = "rbxassetid://8666601749",
Duration = 10,
Color = Success
})
game:GetService("StarterGui"):SetCore("SendNotification",{  
Title = "Lunar Hub by BenjaponTH",     
Text = player.Name,
Icon = content,
Duration = 10,
Color = Info
...
-- Window --
local Win = Blacklib:Window("Lunar Hub")
-- Tab --
local Tabes = Win:Tab("Main", img)

Tabes:Label("Auto Functions")

Tabes:Line()
Tabes:Note("Note")

Tabes:Button("Auto HakiPad + Ripindra", function()
    local args = {
    [1] = "activateColor", 
    [2] = "Winter Sky"
}
...
local Tabes = Win:Tab("Stats")
Tabes:Label("stats")

local Tabes = Win:Tab("Player + Aimbot")
...
Tabes:Dropdown("Select Player", " ", players, function(abc)
    Select = abc
end)


Tabes:Button("Refresh", function()
    table.clear(players)
for i,v in pairs(game:GetService("Players"):GetChildren()) do
   table.insert(players,v.Name)
end
...
Tabes:Button("Teleport", function()
    game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = game.Players[Select].Character.HumanoidRootPart.CFrame
end)


local Tabes = Win:Tab("Other Hub")

Tabes:Label("You're noob player lol")
Tabes:Line()

Tabes:Button("MukuroHub", function()
    loadstring(game:HttpGet"https://raw.githubusercontent.com/Zyrex-X/MukuroHubAndriond/main/README.md")()
end)
Tabes:Button("UI Toggles MukuroHub", function()
...
Tabes:Button("Idk hub", function()
    loadstring(game:HttpGet("https://raw.githubusercontent.com/MynameIsDoit/HEEHITBOX/main/HITBOXLEK"))()
end)
Tabes:Button("MaruHub", function()
    -- แนะนำใช้โลก3
...
loadstring(game:HttpGet("https://raw.githubusercontent.com/xshiba/Free-Script/main/Bounty.lua"))()
